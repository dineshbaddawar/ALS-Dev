({
    ...
    createLeadHandle: function (component, event, helper) {
        debugger;
        //let Fields = ['Salutation__c', 'First_Name__c', 'Name', 'Company__c', 'GenderIdentity__c', 'Company_Type__c', 'Mark_Visit_as_Completed__c', 'Website__c', 'Description__c', 'Industry__c', 'Industry_Verticle__c','Lead_Source__c', 'Lead_Status__c', 'Customer_Presence__c', 'Enquiry_type__c', 'Annual_turnover__c', 'Annual_Turnover_Unit__c', 'Budget__c', 'Competitor_for_Symega__c', 'Product_requirement_time_line__c', 'Customer_expects_any_Exclusivity__c', 'Product_Family__c', 'City', 'Street', 'State', 'Country', 'PostalCode', 'Visible_potential_COLOR__c', 'Visible_potential_CPD__c', 'Visible_potential_FLAVOR__c', 'visible_potential_PLANT_based__c', 'visible_potential_SPD__c', 'Potential_Requirement_COLOR__c', 'Potential_Requirement_CPD__c', 'Potential_Requirement_FLAVOR__c', 'Potential_Requirement_PLANT_based__c', 'Potential_Requirement_SPD__c', 'Customer_expectation_from_Symega__c'];
